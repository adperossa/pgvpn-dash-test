...
var KTDialog = function(t) {
    var e, a = this, n = KTUtil.getBody(), i = {
        ...
        show: function() {
            ...
            "top center" == a.options.placement && KTUtil.addClass(e, "dialog-top-center"),
            n.appendChild(e),
            a.state = "shown",
...
var KTHeader = function(t, e) {
    ...
    if (void 0 !== n) {
        var o = {
          ...
          , l = {
            construct: function(t) {
                return KTUtil.data(n).has("header") ? a = KTUtil.data(n).get("header") : (l.init(t),
                l.build(),
            ...
            build: function() {
                ...
                window.addEventListener("scroll", function() {
                    var n, o = 0;
                    KTUtil.isBreakpointDown("lg") && !1 === a.options.offset.tabletAndMobile || KTUtil.isBreakpointUp("lg") && !1 === a.options.offset.desktop || (KTUtil.isBreakpointUp("lg") ? o = a.options.offset.desktop : KTUtil.isBreakpointDown("lg") && (o = a.options.offset.tabletAndMobile),
                    n = KTUtil.getScrollTop(),
                    KTUtil.isBreakpointDown("lg") && a.options.releseOnReverse.tabletAndMobile || KTUtil.isBreakpointUp("lg") && a.options.releseOnReverse.desktop ? (n > o && e < n ? (!1 === i.hasAttribute("data-header-scroll") && i.setAttribute("data-header-scroll", "on"),
                    t && (l.eventTrigger("scrollOn", a),
                    t = !1)) : (!0 === i.hasAttribute("data-header-scroll") && i.removeAttribute("data-header-scroll"),
                    0 == t && (l.eventTrigger("scrollOff", a),
                    t = !0)),
                    e = n) : n > o ? (!1 === i.hasAttribute("data-header-scroll") && i.setAttribute("data-header-scroll", "on"),
                    t && (l.eventTrigger("scrollOn", a),
                    t = !1)) : (!0 === i.hasAttribute("data-header-scroll") && i.removeAttribute("data-header-scroll"),
                    0 == t && (l.eventTrigger("scrollOff", a),
                    t = !0)))
            ...
            eventTrigger: function(t, e) {
                for (var n = 0; n < a.events.length; n++) {
                    ...
                    if (i.name == t) {
                        if (1 != i.one)
                            return i.handler.call(this, a, e);
                        if (0 == i.fired)
...
var KTMenu = function(t, e) {
    ...
    if (i) {
        var l = {
          ...
          , r = {
            construct: function(t) {
                return KTUtil.data(i).has("menu") ? a = KTUtil.data(i).get("menu") : (r.init(t),
                r.reset(),
                r.build(),
            ...
            build: function() {
                a.eventHandlers.event_1 = KTUtil.on(i, ".menu-toggle", "click", r.handleSubmenuAccordion),
                ("dropdown" === r.getSubmenuMode() || r.isConditionalSubmenuDropdown()) && (a.eventHandlers.event_2 = KTUtil.on(i, '[data-menu-toggle="hover"]', "mouseover", r.handleSubmenuDrodownHoverEnter),
                a.eventHandlers.event_3 = KTUtil.on(i, '[data-menu-toggle="hover"]', "mouseout", r.handleSubmenuDrodownHoverExit),
                a.eventHandlers.event_4 = KTUtil.on(i, '[data-menu-toggle="click"] > .menu-toggle, [data-menu-toggle="click"] > .menu-link .menu-toggle', "click", r.handleSubmenuDropdownClick),
                a.eventHandlers.event_5 = KTUtil.on(i, '[data-menu-toggle="tab"] > .menu-toggle, [data-menu-toggle="tab"] > .menu-link .menu-toggle', "click", r.handleSubmenuDropdownTabClick)),
                a.eventHandlers.event_6 = KTUtil.on(i, ".menu-item > .menu-link:not(.menu-toggle):not(.menu-link-toggle-skip)", "click", r.handleLinkClick),
            ...
            scrollInit: function() {
                a.options.scroll && a.options.scroll.height ? (KTUtil.scrollDestroy(i, !0),
                KTUtil.scrollInit(i, {
                    mobileNativeScroll: !0,
                    windowScroll: !1,
            ...
            resetSubmenuProps: function(t) {
                ...
                if (e)
                    for (var a = 0, n = e.length; a < n; a++) {
                        ...
                        o.hasAttribute("data-hor-direction") && (KTUtil.removeClass(o, "menu-submenu-left"),
                        KTUtil.removeClass(o, "menu-submenu-right"),
                        KTUtil.addClass(o, o.getAttribute("data-hor-direction")))
                    }
            },
            ...
            handleSubmenuDropdownClick: function(t) {
                if ("accordion" !== r.getSubmenuMode(this)) {
                    ...
                    !1 !== r.eventTrigger("submenuToggle", this, t) && "accordion" != e.getAttribute("data-menu-submenu-mode") && (!1 === KTUtil.hasClass(e, "menu-item-hover") ? (KTUtil.addClass(e, "menu-item-open-dropdown"),
                    r.showSubmenuDropdown(e)) : (KTUtil.removeClass(e, "menu-item-open-dropdown"),
            ...
            handleSubmenuDropdownTabClick: function(t) {
                if ("accordion" !== r.getSubmenuMode(this)) {
                    var e = this.closest(".menu-item");
                    !1 !== r.eventTrigger("submenuToggle", this, t) && "accordion" != e.getAttribute("data-menu-submenu-mode") && (0 == KTUtil.hasClass(e, "menu-item-hover") && (KTUtil.addClass(e, "menu-item-open-dropdown"),
            ...
            handleSubmenuAccordion: function(t, e) {
                ...
                if (!1 !== r.eventTrigger("submenuToggle", this, t))
                    if ("dropdown" === r.getSubmenuMode(e) && (n = i.closest(".menu-item")) && "accordion" != n.getAttribute("data-menu-submenu-mode"))
                        t.preventDefault();
                    else {
            ...
            hideSubmenuDropdown: function(t, e) {
                e && (KTUtil.removeClass(t, "menu-item-hover"),
                KTUtil.removeClass(t, "menu-item-active-tab")),
                t.removeAttribute("data-hover"),
                t.getAttribute("data-menu-toggle-class") && KTUtil.removeClass(o, t.getAttribute("data-menu-toggle-class"));
            ...
            showSubmenuDropdown: function(t) {
                ...
                s && !1 === s.hasAttribute("data-hor-direction") && (KTUtil.hasClass(s, "menu-submenu-left") ? s.setAttribute("data-hor-direction", "menu-submenu-left") : KTUtil.hasClass(s, "menu-submenu-right") && s.setAttribute("data-hor-direction", "menu-submenu-right")),
                s && !0 === KTUtil.isOffscreen(s, "left", 15) ? (KTUtil.removeClass(s, "menu-submenu-left"),
                KTUtil.addClass(s, "menu-submenu-right")) : s && !0 === KTUtil.isOffscreen(s, "right", 15) && (KTUtil.removeClass(s, "menu-submenu-right"),
                KTUtil.addClass(s, "menu-submenu-left")),
                t.getAttribute("data-menu-toggle-class") && KTUtil.addClass(o, t.getAttribute("data-menu-toggle-class"))
            },
            createSubmenuDropdownClickDropoff: function(t) {
                var e, a = (e = KTUtil.child(t, ".menu-submenu") ? KTUtil.css(e, "z-index") : 0) - 1, n = document.createElement('<div class="menu-dropoff" style="background: transparent; position: fixed; top: 0; bottom: 0; left: 0; right: 0; z-index: ' + a + '"></div>');
                o.appendChild(n),
            ...
            eventTrigger: function(t, e, n) {
                for (var i = 0; i < a.events.length; i++) {
                    ...
                    if (o.name == t) {
                        if (1 != o.one)
                            return o.handler.call(this, e, n);
                        if (0 == o.fired)
                            return a.events[i].fired = !0,
...
var KTOffcanvas = function(t, e) {
    ...
    if (n) {
        var o = {
          ...
          , l = {
            construct: function(t) {
                return KTUtil.data(n).has("offcanvas") ? a = KTUtil.data(n).get("offcanvas") : (l.init(t),
                l.build(),
            ...
            build: function() {
                if (a.options.toggleBy)
                    if ("string" == typeof a.options.toggleBy)
                        KTUtil.addEvent(KTUtil.getById(a.options.toggleBy), "click", function(t) {
                            t.preventDefault(),
                            a.target = this,
                            l.toggle()
                        });
                        ...
                        a.options.toggleBy && a.options.toggleBy.target && KTUtil.addEvent(KTUtil.getById(a.options.toggleBy.target), "click", function(t) {
                            t.preventDefault(),
                            a.target = this,
                            l.toggle()
                        });
            ...
            show: function() {
                ...
                a.attrCustom.length > 0 && KTUtil.attr(i, "data-offcanvas-" + a.classCustom, "on"),
                a.state = "shown",
                a.options.overlay && (a.overlay = KTUtil.insertAfter(document.createElement("DIV"), n),
            ...
            hide: function() {
                ...
                a.attrCustom.length > 0 && KTUtil.removeAttr(i, "data-offcanvas-" + a.attrCustom),
                a.state = "hidden",
            ...
            toggleClass: function(t) {
                ...
                if (a.options.toggleBy && a.options.toggleBy[0] && a.options.toggleBy[0].target)
                    ...
                    a.options.toggleBy && a.options.toggleBy.target && (e = a.options.toggleBy);
                if (e) {
...
var KTScrolltop = function(t, e) {
    ...
    if (n) {
        var o = {
          ...
          , l = {
            construct: function(t) {
                return KTUtil.data(n).has("scrolltop") ? a = KTUtil.data(n).get("scrolltop") : (l.init(t),
                l.build(),
            ...
            scroll: function(t) {
                t.preventDefault(),
                KTUtil.scrollTop(0, a.options.speed)
            },
            eventTrigger: function(t, e) {
                for (var n = 0; n < a.events.length; n++) {
                    var i = a.events[n];
...
var KTToggle = function(t, e) {
    ...
    if (n) {
        var i = {
          ...
          , o = {
            construct: function(t) {
                return KTUtil.data(n).has("toggle") ? a = KTUtil.data(n).get("toggle") : (o.init(t),
                o.build(),
            ...
            init: function(t) {
                ...
                a.events = [],
                a.options = KTUtil.deepExtend({}, i, t),
                a.target = KTUtil.getById(t.target),
                a.targetState = a.options.targetState,
                a.toggleState = a.options.toggleState,
                "class" == a.options.targetToggleMode ? a.state = KTUtil.hasClasses(a.target, a.targetState) ? "on" : "off" : a.state = KTUtil.hasAttr(a.target, "data-" + a.targetState) ? KTUtil.attr(a.target, "data-" + a.targetState) : "off"
            },
            build: function() {
                KTUtil.addEvent(n, "mouseup", o.toggle)
            },
            toggle: function(t) {
                return o.eventTrigger("beforeToggle"),
            ...
            toggleOn: function() {
                return o.eventTrigger("beforeOn"),
                "class" == a.options.targetToggleMode ? KTUtil.addClass(a.target, a.targetState) : KTUtil.attr(a.target, "data-" + a.targetState, "on"),
            ...
            toggleOff: function() {
                return o.eventTrigger("beforeOff"),
                "class" == a.options.targetToggleMode ? KTUtil.removeClass(a.target, a.targetState) : KTUtil.removeAttr(a.target, "data-" + a.targetState),
...
var KTUtil = function() {
    ...
    return {
        ...
        isMobileDevice: function() {
            ...
            return !1 === t && (t = null != navigator.userAgent.match(/iPad/i)),
            t
        },
        ...
        getHighestZindex: function(t) {
            for (var e, a; t && t !== document; ) {
                if (("absolute" === (e = KTUtil.css(t, "position")) || "relative" === e || "fixed" === e) && (a = parseInt(KTUtil.css(t, "z-index")),
                !isNaN(a) && 0 !== a))
                    return a;
                t = t.parentNode
            }
        ...
        hasFixedPositionedParent: function(t) {
            for (; t && t !== document; ) {
                if ("fixed" === KTUtil.css(t, "position"))
                    return !0;
                t = t.parentNode
            }
            return !1
        ...
        data: function(t) {
            return {
                set: function(e, a) {
                    t && (void 0 === t.customDataTag && (window.KTUtilElementDataStoreID++,
                ...
                get: function(e) {
                    if (t)
                        return void 0 === t.customDataTag ? null : this.has(e) ? window.KTUtilElementDataStore[t.customDataTag][e] : null
                },
                has: function(e) {
        ...
        outerWidth: function(t, e) {
            var a;
            return !0 === e ? (a = parseFloat(t.offsetWidth),
            a += parseFloat(KTUtil.css(t, "margin-left")) + parseFloat(KTUtil.css(t, "margin-right")),
            parseFloat(a)) : a = parseFloat(t.offsetWidth)
        },
        offset: function(t) {
            var e, a;
            if (t)
        ...
        outerHeight: function(t, e=!1) {
            ...
            return e ? (a = getComputedStyle(t),
            n += parseInt(a.marginTop) + parseInt(a.marginBottom)) : n
        },
        visible: function(t) {
        ...
        actualCss: function(t, e, a) {
            ...
            if (t instanceof HTMLElement != !1)
                return t.getAttribute("kt-hidden-" + e) && !1 !== a ? parseFloat(t.getAttribute("kt-hidden-" + e)) : (i = t.style.cssText,
        ...
        slide: function(t, e, a, n, i) {
            if (!(!t || "up" == e && !1 === KTUtil.visible(t) || "down" == e && !0 === KTUtil.visible(t))) {
                ...
                l && KTUtil.animate(0, l, a, function(e) {
        ...
        off: function(t, e, a) {
            t && window.KTUtilDelegatedEventHandlers[a] && (KTUtil.removeEvent(t, e, window.KTUtilDelegatedEventHandlers[a]),
            delete window.KTUtilDelegatedEventHandlers[a])
        },
        one: function(t, e, a) {
            t.addEventListener(e, function e(n) {
                return n.target && n.target.removeEventListener && n.target.removeEventListener(n.type, e),
                t && t.removeEventListener && n.currentTarget.removeEventListener(n.type, e),
                a(n)
            })
        },
        hash: function(t) {
        ...
        scrollTo: function(t, e, a) {
            a = a || 500;
            var n, i, o = t ? KTUtil.offset(t).top : 0, l = window.pageYOffset || document.documentElement.scrollTop || document.body.scrollTop || 0;
            e && (l += e),
            n = l,
            i = o,
        ...
        isRTL: function() {
            ...
            if (t)
                return "rtl" == KTUtil.attr(t, "direction")
        },
        scrollInit: function(t, e) {
            if (t) {
                ...
                a(),
                e.handleWindowResize && KTUtil.addResizeHandler(function() {
                    a()
                })
            }
            function a() {
                ...
                !1 !== (n = e.height instanceof Function ? e.height.call() : !0 === KTUtil.isMobileDevice() && e.mobileHeight ? parseInt(e.mobileHeight) : parseInt(e.height)))
                    if (n = parseInt(n),
                    !e.mobileNativeScroll && !e.disableForMobile || !0 !== KTUtil.isMobileDevice())
                        if (n > 0 && KTUtil.css(t, "height", n + "px"),
                        e.desktopNativeScroll)
                            KTUtil.css(t, "overflow", "auto");
                        else {
                            "true" == KTUtil.attr(t, "data-window-scroll") && (e.windowScroll = !0),
                            (a = KTUtil.data(t).get("ps")) ? a.update() : (KTUtil.css(t, "overflow", "hidden"),
                        ...
                        (a = KTUtil.data(t).get("ps")) ? (e.resetHeightOnDestroy ? KTUtil.css(t, "height", "auto") : (KTUtil.css(t, "overflow", "auto"),
                        n > 0 && KTUtil.css(t, "height", n + "px")),
                        a.destroy(),
                        a = KTUtil.data(t).remove("ps")) : n > 0 && (KTUtil.css(t, "overflow", "auto"),
                        KTUtil.css(t, "height", n + "px"));
                else
                    KTUtil.scrollDestroy(t, !0)
            }
        },
        ...
        scrollDestroy: function(t, e) {
            ...
            t && e && (t.style.setProperty("overflow", ""),
        ...
        colorDarken: function(t, e) {
            ...
            return t = t.indexOf("#") >= 0 ? t.substring(1, t.length) : t,
            e = parseInt(255 * e / 100),
            `#${a(t.substring(0, 2), e)}${a(t.substring(2, 4), e)}${a(t.substring(4, 6), e)}`
        },
        ...
        btnWait: function(t, e, a, n=!0) {
            if (t && (n && KTUtil.attr(t, "disabled", !0),
            e && (KTUtil.addClass(t, e),
            KTUtil.attr(t, "wait-class", e)),
            a)) {
                var i = KTUtil.find(t, ".btn-caption");
                i ? (KTUtil.data(i).set("caption", KTUtil.getHTML(i)),
                KTUtil.setHTML(i, a)) : (KTUtil.data(t).set("caption", KTUtil.getHTML(t)),
                KTUtil.setHTML(t, a))
            }
        },
        btnRelease: function(t) {
            if (t) {
                ...
                KTUtil.hasAttr(t, "wait-class") && KTUtil.removeClass(t, KTUtil.attr(t, "wait-class"));
    ...
    if (n) {
        var i = {
          ...
          , o = {
            ...
            goTo: function(t, e) {
                if (console.log("go to:" + t),
                !(t === a.currentStep || t > a.totalSteps || t < 0)) {
                    var n;
                ...
                sorting: function() {
                    var e = {
                        ...
                        sortClick: function(n) {
                            ...
                            if (void 0 !== d && (void 0 === d.sortable || !1 !== d.sortable) && (void 0 === d.selector || !0 !== d.selector) && (t(o.tableHead).find("th").removeClass("datatable-cell-sorted"),
...
var KTLayoutAsideMenu = function() {
    ...
    return {
        init: function(a) {
            var n, i;
            (t = KTUtil.getById(a)) && (i = "1" === KTUtil.attr(t, "data-menu-dropdown") ? "dropdown" : "accordion",
            "1" === KTUtil.attr(t, "data-menu-scroll") && (n = {
                rememberPosition: !0,
                height: function() {
                    var e = parseInt(KTUtil.getViewPort().height);
                    return KTUtil.isBreakpointUp("lg") && (e -= KTLayoutBrand.getHeight()),
                    e -= parseInt(KTUtil.css(t, "marginBottom")) + parseInt(KTUtil.css(t, "marginTop"))
                }
            }),
            (e = new KTMenu(t,{
                scroll: n,
                ...
                if (!0 === KTLayoutAside.isMinimized() && !1 === KTLayoutAside.isHoverable())
                    return !1
            }),
    ...
    return {
        init: function(n) {
            ...
            e && ((a = new KTToggle(e,{
                ...
                void 0 !== KTLayoutStickyCard && KTLayoutStickyCard.update(),
                void 0 !== KTLayoutHeaderMenu && KTLayoutHeaderMenu.pauseDropdownHover(800),
                void 0 !== KTLayoutAsideMenu && KTLayoutAsideMenu.pauseDropdownHover(800),
                KTCookie.setCookie("kt_aside_toggle_state", t.getState())
            }),
...
var KTLayoutAside = function() {
    ...
    return {
        init: function(n) {
            ...
            (e = KTUtil.getById(n),
            t = KTUtil.getBody(),
            e) && (l = KTUtil.hasClass(e, "aside-offcanvas-default") ? "aside-offcanvas-default" : "aside",
            a = new KTOffcanvas(e,{
                baseClass: l,
                overlay: !0,
            ...
            KTUtil.hasClass(t, "aside-fixed") && KTUtil.hasClass(t, "aside-minimize-hoverable") && (KTUtil.addEvent(e, "mouseenter", function(e) {
                e.preventDefault(),
                !1 !== KTUtil.isBreakpointUp("lg") && (o && (clearTimeout(o),
                o = null),
                i = setTimeout(function() {
                    KTUtil.hasClass(t, "aside-minimize") && KTUtil.isBreakpointUp("lg") && (KTUtil.removeClass(t, "aside-minimize"),
            ...
            KTUtil.addEvent(e, "mouseleave", function(e) {
                e.preventDefault(),
                !1 !== KTUtil.isBreakpointUp("lg") && (i && (clearTimeout(i),
                i = null),
                o = setTimeout(function() {
                    KTUtil.hasClass(t, "aside-minimize-hover") && KTUtil.isBreakpointUp("lg") && (KTUtil.removeClass(t, "aside-minimize-hover"),
...
var KTLayoutContent = function() {
    ...
    return {
        ...
        getHeight: function() {
            return e = KTUtil.getViewPort().height,
            t && (e = e - parseInt(KTUtil.css(t, "paddingTop")) - parseInt(KTUtil.css(t, "paddingBottom"))),
            ...
            (e = new KTCard(t,{
                sticky: {
                    ...
                    position: {
                        top: function() {
                            var t = 0;
                            return KTUtil.getBody(),
                            KTUtil.isBreakpointUp("lg") ? (void 0 !== KTLayoutHeader && KTLayoutHeader.isFixed() && (t += KTLayoutHeader.getHeight()),
                            void 0 !== KTLayoutSubheader && KTLayoutSubheader.isFixed() && (t += KTLayoutSubheader.getHeight())) : void 0 !== KTLayoutHeader && KTLayoutHeader.isFixedForMobile() && (t += KTLayoutHeader.getHeightForMobile()),
                            t -= 1
                        },
                        left: function(e) {
...
var KTLayoutChat = function() {
    var t = function(t) {
        ...
        a && (KTUtil.scrollInit(a, {
            ...
            height: function() {
                var t;
                return KTUtil.isBreakpointDown("lg") ? KTUtil.hasAttr(a, "data-mobile-height") ? parseInt(KTUtil.attr(a, "data-mobile-height")) : 400 : KTUtil.isBreakpointUp("lg") && KTUtil.hasAttr(a, "data-height") ? parseInt(KTUtil.attr(a, "data-height")) : (t = KTLayoutContent.getHeight(),
                a && (t = t - parseInt(KTUtil.css(a, "margin-top")) - parseInt(KTUtil.css(a, "margin-bottom"))),
                i && (t = (t -= parseInt(KTUtil.css(i, "height"))) - parseInt(KTUtil.css(i, "margin-top")) - parseInt(KTUtil.css(i, "margin-bottom"))),
                n && (t = t - parseInt(KTUtil.css(n, "padding-top")) - parseInt(KTUtil.css(n, "padding-bottom"))),
                o && (t = (t -= parseInt(KTUtil.css(o, "height"))) - parseInt(KTUtil.css(o, "margin-top")) - parseInt(KTUtil.css(o, "margin-bottom"))),
                t -= 2)
            }
        }),
      ...
      , e = function(t) {
        ...
        if (0 !== n.value.length) {
            ...
            l += "\t<div>",
            l += '\t\t<span class="text-muted font-size-sm">2 Hours</span>',
            l += '\t\t<a href="#" class="text-dark-75 text-hover-primary font-weight-bold font-size-h6">You</a>',
            l += "\t</div>",
            l += '\t<div class="symbol symbol-circle symbol-40 ml-3">',
            l += '\t\t<img alt="Pic" src="assets/media/users/300_12.jpg"/>',
            l += "\t</div>",
            l += "</div>",
            l += '<div class="mt-2 rounded p-5 bg-light-primary text-dark-50 font-weight-bold font-size-lg text-right max-w-400px">' + n.value + "</div>",
            KTUtil.setHTML(i, l),
            e.appendChild(i),
            n.value = "",
        ...
        init: function(a) {
            (t = KTUtil.getById(a)) && (!function() {
                ...
                KTUtil.scrollInit(i, {
                    ...
                    height: function() {
                        var e = parseInt(KTUtil.getViewPort().height);
                        return a && (e -= parseInt(KTUtil.actualHeight(a)),
                        e -= parseInt(KTUtil.css(a, "marginTop")),
                        e -= parseInt(KTUtil.css(a, "marginBottom"))),
                        n && (e -= parseInt(KTUtil.css(n, "marginTop")),
                        e -= parseInt(KTUtil.css(n, "marginBottom"))),
                        i && (e -= parseInt(KTUtil.css(i, "marginTop")),
                        e -= parseInt(KTUtil.css(i, "marginBottom"))),
                        o && (e -= parseInt(KTUtil.actualHeight(o)),
            ...
            for (var a = 0; a < e.length; ++a) {
                ...
                new ClipboardJS(i,{
                    target: function(t) {
                        ...
                        return a || (a = KTUtil.find(e, ".example-code")),
                        a
                    }
...
var KTLayoutQuickActions = function() {
    ...
    return {
        init: function(e) {
            var a, n;
            (t = KTUtil.getById(e)) && (a = KTUtil.find(t, ".offcanvas-header"),
            n = KTUtil.find(t, ".offcanvas-content"),
            new KTOffcanvas(t,{
                overlay: !0,
                baseClass: "offcanvas",
            ...
            (t = KTUtil.getById(e)) && function() {
                ...
                KTUtil.scrollInit(n, {
                    ...
                    height: function() {
                        ...
                        return e && (o -= parseInt(KTUtil.actualHeight(e)),
                        o -= parseInt(KTUtil.css(e, "marginTop")),
                        o -= parseInt(KTUtil.css(e, "marginBottom"))),
                        a && (o -= parseInt(KTUtil.css(a, "marginTop")),
                        o -= parseInt(KTUtil.css(a, "marginBottom"))),
                        n && (o -= parseInt(KTUtil.css(n, "marginTop")),
                        o -= parseInt(KTUtil.css(n, "marginBottom"))),
                        i && (o -= parseInt(KTUtil.actualHeight(i)),
...
var KTLayoutQuickPanel = function() {
    var t, e, a, n, i = function() {
        ...
        return e && (n -= parseInt(KTUtil.actualHeight(e)),
        n -= parseInt(KTUtil.css(e, "marginTop")),
        n -= parseInt(KTUtil.css(e, "marginBottom"))),
        a && (n -= parseInt(KTUtil.css(a, "marginTop")),
        ...
        init: function(e) {
            ...
            KTUtil.scrollInit(o, {
                ...
                height: function() {
                    ...
                    n && (e -= parseInt(KTUtil.css(n, "marginTop")),
                    e -= parseInt(KTUtil.css(n, "marginBottom"))),
                    o && (e -= parseInt(KTUtil.actualHeight(i)),
...
var KTLayoutSearch = function() {
        ...
        setTimeout(function() {
            $.ajax({
                ...
                error: function(e) {
                    ...
                    f(),
                    KTUtil.addClass(t, p),
                    KTUtil.setHTML(i, '<span class="font-weight-bold text-muted">Connection error. Please try again later..</div>'),
                    g(),
                    KTUtil.scrollUpdate(i)
                }
            })
    ...
    return {
        init: function(s) {
            (t = KTUtil.getById(s)) && (e = KTUtil.find(t, ".quick-search-form"),
